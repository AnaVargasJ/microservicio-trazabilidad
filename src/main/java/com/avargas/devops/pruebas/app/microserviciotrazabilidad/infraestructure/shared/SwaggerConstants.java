...
public class SwaggerConstants {
    ...
    public static final String OP_RANKING_EMPLEADOS_SUMMARY = "Consultar ranking por empleado";
    public static final String OP_RANKING_EMPLEADOS_DESC = "Muestra el tiempo promedio que tarda cada empleado en completar un pedido.";
